...
export default function GameCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setGameDescriptionH2(initialValues.gameDescriptionH2);
    setGameDescriptionH3(initialValues.gameDescriptionH3);
    setGameDescriptionP(initialValues.gameDescriptionP);
    setGameLocationPlace(initialValues.gameLocationPlace);
    setGameLocationCity(initialValues.gameLocationCity);
    setGameType(initialValues.gameType);
    setGameStopString(initialValues.gameStopString);
